# Generated by Django 5.1.4 on 2024-12-05 11:23
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('core', '0002_rename_current_country_id_actor_current_country_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='actor_additional_info',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('available', models.BooleanField()),
                ('approved', models.BooleanField()),
                ('actor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.user')),
                ('current_country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.countries')),
            ],
        ),
